...
const Middle = () => {
  return (
    <>
      ...
      <div>
        <div
          className="container-fluid p-0 mb-5 wow MiddleInDadeInClass fadeIn"
          data-wow-delay="0.1s"
        >
          <div
            id="header-carousel"
              ...
              <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <p>
                  <svg
                    ...
                    style={{ marginRight: "0.5rem", color: "#3cb815" }}
                  >
              ...
              >
                ...
                <div className="bg-light p-4">
                  ...
                  <div className="text-muted border-top pt-4">
                    ...
                    <small className="me-3">
                      <i className="fa fa-calendar text-primary me-2"></i>01
                      Jan, 2045
                    </small>
                  </div>
                </div>
